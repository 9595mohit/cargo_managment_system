...
public class VerifyUser extends javax.swing.JFrame {
    ...
    public void getAllRecords() {
        ...
        dtm.setRowCount(0);
        ArrayList<User> user=UserDao.getAllRecords();
        ...
        while(itr.hasNext())
        {
            ...
            {
                dtm.addRow(new Object[]{userObj.getId(),userObj.getName(),userObj.getEmail(),userObj.getMobileNumber(),userObj.getAdress(),userObj.getSecurityQuestion(),userObj.getStatus()});
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 11, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "Mobile Number", "Adress", "Sequrity Question", "status"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 88, 1580, 730));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("**Click On The Row To Change User Status");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(371, 836, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1520, 20, -1, 30));
